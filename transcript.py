...
# --- Config ---
csv_path = "youtube_batch_20250915_171855.csv"
...
if os.path.exists(output_path):
    ...
    if 'video_id' in existing_df.columns and 'transcript' in existing_df.columns:
...
transcripts_data = pd.read_csv(output_path).to_dict('records') if os.path.exists(output_path) else []
failed_data = pd.read_csv(failed_path).to_dict('records') if os.path.exists(failed_path) else []
